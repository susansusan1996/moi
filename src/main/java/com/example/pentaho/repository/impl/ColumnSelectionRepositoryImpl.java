        ...
        try {
            Query query = Query.builder()
                    .append("INSERT INTO addr_system.COLUMN_SELECTION \n" +
                           "(FORM_ID, USER_ID ,COUNTY, TOWN, VILLAGE, NEIGHBOR_CD, ROAD, AREA, LANE, ALLEY, SUBALLEY, NUM_TYPE, NUM_FLR, ROOM, X, Y, VERSION, TOWN_SN, GEO_HASH, ROAD_ID, ROAD_ID_DT, POST_CODE, POSTCODE_DT, SOURCE, VALIDITY, INTEGRITY)" +
                            " VALUES (")
